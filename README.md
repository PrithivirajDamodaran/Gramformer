...
- For the beta / pre-release experiments, I generated error edit pairs from 1st source and used W&I+LOCNESS from the 3rd source to filter the pairs with grammatical edits only. W&I+LOCNESS is available via [Huggingface dataset](https://huggingface.co/datasets/wi_locness). Th W&I+LOCNESS was ONLY used to harvest different patterns of grammar errors.
