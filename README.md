...
(If install runs endlessly resolving package versions in for instance colab, refer to [issue #22](https://github.com/PrithivirajDamodaran/Gramformer/issues/22))
```
## Quick Start
