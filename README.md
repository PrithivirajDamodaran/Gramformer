...
- The pre-release (any release < v1.1) package (and the model) is **NOT** intended for any commercial usage.
- Stable releases are v1.1 onwards, current release is v1.2
