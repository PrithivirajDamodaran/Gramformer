...
setuptools.setup(
    ...
    install_requires=['transformers==4.6.1', 'sentencepiece==0.1.95', 'python-Levenshtein==0.12.2', 'fuzzywuzzy==0.18.0',  'tokenizers==0.10.2', 'fsspec==2021.5.0', 'lm-scorer==0.4.2'],
    classifiers=[
